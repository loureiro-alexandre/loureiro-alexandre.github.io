...
If you are familiar with this macro-ecology area of inquiry, you might have heard that species diversity decreases with elevation either in linear fashion or in a hump-shaped trend. Statements like these lead you to believe that area of ecology is solved, and that these patterns must, therefore, be expected everywhere and with every taxa. That may be true to some extent, but that extent is not nearly as extensive as it seems! The papers that lead to statements like those are mostly meta-analyeses or reviews that attempt to summarise what these patterns are, and they tend to use mostly vertebrate data. Is expected, then, that these vertebrate patterns be seen in invertebrate communities? That is not so clear. Indeed, there are few papers that review or meta-analyse diversity patterns along elevation gradients for invertebrates. I'm on a mission to do that for the most diverse animal order in the world, the Coleoptera (beetles)!

### Ant thermal tolerance along a field-forest gradient in Guelph, Ontario

Often, we find species where they are because of some abiotic variable that dictates where a species can and cannot be. Temperature is a well-known driver of species distributions, but it is not always the case that they are the causal factor. One way to find more evidence of the direct effects of temperature on the distribution of any given species is to measure some physiological traits that are known respond to those effects, and then map how they change with the community and map that onto the environmental temperature changes. In this chapter of mine, I am doing just that for the ant community in a field-forest gradient in Guelph, Ontario! I am measuring workers heat and cold tolerance for many species and tracking how those numbers change along the environmental gradient, and how well those changes can be explained by changes in temperature!
...
That being said, there was still so much to explore! For instance, the fields in the <a href="https://doi.org/10.4039/tce.2012.76" target="_blank">2012</a> study were relatively small, which begged the question of whether the community distribution trends they observed would also be seen in larger fields. Therefore, we designed one of my chapters to explore this very question, and we found that carabid abundance increased with distance from the field edge, but that their genus richness (number of genera) did not change. 

We also found, in a study that was a separate chapter but got integrated into the same paper as the diversity study, that the most abundant carabid species in blueberry fields, *Harpalus rufipes*, displaces itself about  14.5 m/day in by walking. We figured this out by marking the beetles with fluorescent paint, releasing them at the center of many concentric rings, and then coming back to look for them with UV flashlights at night! I must say, that was arguably the most fun part of my MSc!

Combining these two studies into one allowed us to look at the carabid community in blueberry fields from the species distribution point of view, all the way to the individual movement point of view, which gave us a more complete idea of how carabids exist in that system. Our study was published by Oxford University Press in the journal *Environmental Entomology*, and you can find it <a href="https://doi.org/10.1093/ee/nvaa047" target="_blank">here</a>.
